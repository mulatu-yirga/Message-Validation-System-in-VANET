...
namespace ns3
{
    ...
    class CustomApplication : public ns3::Application
    {
        public: 
            ...
            void MonitorTx (const Ptr< const Packet > packet, uint16_t channelFreqMhz, WifiTxVector txVector, MpduInfo aMpdu);

            void SetBroadcastInterval (Time interval);
            void PhyTxDropTrace (Ptr <const Packet> packet);
            void PhyRxDropTrace (Ptr<const Packet>);
            //void PhyRxDropTrace (Ptr<const Packet>, WifiPhyRxfailureReason reason);
